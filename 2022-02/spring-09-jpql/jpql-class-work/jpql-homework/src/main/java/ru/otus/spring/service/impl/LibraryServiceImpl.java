...
public class LibraryServiceImpl implements LibraryService {
    ...
    public List<String> getAllBookName() {
        return bookRepository.findAllBookName();
    }
    ...
    public BookDto getBookById(long id) {
        ...
        if (book != null) {
            ...
            out.println(String.format("Книга с id=%d не найдена", id));
            return null;
        }
    ...
    public BookDto getBookByName(String name) {
        ...
        if (book != null) {
            ...
            out.println(String.format("Книга с name=%s не найдена", name));
            return null;
        }
    }
    ...
    public void deleteBookById(long id) {
        ...
        out.println(String.format("Книга с id=%d удалена", id));
    }
    ...
    public void deleteBookByName(String name) {
        ...
        out.println(String.format("Книга с name=%s удалена", name));
    }
