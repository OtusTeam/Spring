...
import ru.otus.work.service.WeatherService;
...
public class BookController {
    ...
    @GetMapping("/")
    @HystrixCommand(commandKey = "getAllBook", fallbackMethod = "getAllBookFallback")
    public String getAllBook(Model model) {
        model.addAttribute("books", bookService.listAll().stream().map(BookDto::toDto).collect(Collectors.toList()));
        model.addAttribute("weather", weatherService.getWeatherAsString());
        return "books";
    }
    ...
    @GetMapping("/books")
    @HystrixCommand(commandKey = "getBookById", fallbackMethod = "getBookByIdFallback",
            commandProperties = {
