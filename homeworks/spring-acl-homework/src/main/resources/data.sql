...
--Комментарии
insert into comment(book_id, `text`) values ((select id from book where name = 'Сильмариллион'), 'Комментарий 1 к книге Сльмариллион');
insert into comment(book_id, `text`) values ((select id from book where name = 'Сильмариллион'), 'Комментарий 2 к книге Сльмариллион');
...
--Пользователи (пароль passw0rd - https://bcrypt-generator.com/)
insert into library_user(username, password, `role`) values ('USER', '$2a$12$4JRoWnNV64pNQmcrU.yL3OfUzn.HIVDe2rBMF3/MsjuBE0vSxAiKS', 'ROLE_USER');
insert into library_user(username, password, `role`) values ('ADMIN', '$2a$12$4JRoWnNV64pNQmcrU.yL3OfUzn.HIVDe2rBMF3/MsjuBE0vSxAiKS', 'ROLE_ADMIN');
insert into library_user(username, password, `role`) values ('GUEST', '$2a$12$4JRoWnNV64pNQmcrU.yL3OfUzn.HIVDe2rBMF3/MsjuBE0vSxAiKS', 'ROLE_GUEST');
